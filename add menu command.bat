...
reg add "HKCR\*\shell\FindHandle" /ve /d %commandName%
reg add "HKCR\*\shell\FindHandle\command" 
reg add "HKCR\*\shell\FindHandle\command" /ve /d "cmd.exe /K %handlePath% \"%%1\"" /f

::add command for folders
reg add "HKCR\Directory\shell\FindHandle" /ve /d %commandName%
reg add "HKCR\Directory\shell\FindHandle\command"
